package com.whydda.kafka.configration;
...
public class ListenerConfiguration {
    ...
    public ConsumerFactory<String, Message> consumerFactory() {
        return new DefaultKafkaConsumerFactory<>(consumerConfigurations(), new org.apache.kafka.common.serialization.StringDeserializer(),
